...
<div class="profile-form">
    ...
    <?= $form->field($model, 'birthdate')->widget(DatePicker::className(),['clientOptions'=>['dateFormat'=>'dd-mm-yyyy']]); ?>

    <?//= $form->field($model, 'gender_id')->textInput() ?>
    <?= $form->field($model, 'gender_id')->dropDownList($model->genderList,['prompt'=>'Choose One']); ?>
